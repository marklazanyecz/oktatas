...
# Legelterjedtebb fordítás: python -> C nyelvi alapú fordító -> bytekód -> gépi kód
...
# Sorközi komment: #, mindent ami ez után van az adott sorban figyelmen kívül hagyja a fordító
# Többsoros komment:
"""
Ez például az
